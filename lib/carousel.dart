...
typedef void CarouselCallback(int index, int total);
...
class Carousel extends StatefulWidget {
  ...
  final CarouselCallback onCarouselChange;
...
class _CarouselState extends State<Carousel> with SingleTickerProviderStateMixin {
  ...
  void callCallback() {
	widget.onCarouselChange(actualIndex, widget.childrenCount);
  }
  ...
  void initState() {
    ...
    _controller.addListener(callCallback);
